      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Provider Preview</a>
          </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select multiple class="form-control selectpicker" name="service[]" data-style="btn btn-link" id="exampleFormControlSelect2" disabled>
